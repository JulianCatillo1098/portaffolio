...
const COMMANDS = {
  ...
  about:
    "Hey There! My name is Julian santiago castillo corredor i am a web developer on my way to becoming a senior developer. in the meantime, i like to play the guitar and play beach volleyball in my spare time, Feel free to visit my <a href ='https://github.com/JulianCatillo1098' target='_blank' style='color:#000;'> Github",
  ls:
    "usr&nbsp;&nbsp;&nbsp;&nbsp;home&nbsp;&nbsp;&nbsp;&nbsp;var&nbsp;&nbsp;&nbsp;&nbsp;root",
  ...
  contact:
    "Email (juan.rondon.bonilla@gmail.com): <a class='link' href='https://mail.google.com/'>Gmail</a><br>Form: <a href='/contact' class='link'> Anon Message</a><br>",
};
